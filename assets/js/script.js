...
(function($) {
    ...
    if ($(window).width() < 1199) {
        ...
        $('.layout3-menu .mobile-search .fa fa-search, .header-2 .mobile-search .fa fa-search').on('click', function () {
...
//grid layout view
    ...
    /*=====================
     18.Add to cart
     ==========================*/
    $('.product-box button .fa fa-shopping-cart').on('click', function () {
        $.notify({
            icon: 'fa fa-check',
            title: 'Success!',
    ...
    /*=====================
     19.Add to wishlist
     ==========================*/
    $('.product-box a .fa fa-heart , .product-box a .fa-heart').on('click', function () {
