                        ...
                        <div class="col-lg-6">
                            <div class="subscribe">
                                <div>
                                    ...
                                    <p>Never Miss Anything From Hijabku By Signing Up To Our Newsletter.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo">Hijabku</div>
                        ...
                        <div class="sub-title">
                            ...
                            <div class="footer-contant">
                                <ul class="contact-list">
                                    <li><i class="fa fa-map-marker"></i>Hijabku Store
                                    </li>
                                    <li><i class="fa fa-phone"></i>Call Us: 085340472927</li>
                                    <li><i class="fa fa-envelope-o"></i>Email Us: <a href="#">store.hijabku@hijabku.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="footer-end">
                            <p><i class="fa fa-copyright" aria-hidden="true"></i>2020 Lea Devs</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="qty-box">
                                        <div class="input-group"><span class="input-group-prepend"><button type="button"
                                                    class="btn quantity-left-minus" data-type="minus" data-field=""><i
                                                        class="fa fa-angle-left"></i></button> </span>
                                            <input type="text" name="quantity" class="form-control input-number"
                                                value="1"> <span class="input-group-prepend"><button type="button"
                                                    class="btn quantity-right-plus" data-type="plus" data-field=""><i
                                                        class="fa fa-angle-right"></i></button></span></div>
                                    </div>
                                </div>
                ...
                <div class="buy_btn">
                    <a href="https://themeforest.net/item/multikart-responsive-ecommerce-html-template/22809967?s_rank=1"
                        target="_blank" class="btn btn-block purchase_btn"><i class="fa fa-shopping-cart"
                            aria-hidden="true"></i> purchase Hijabku now!</a>
                    <a href="https://themeforest.net/item/multikart-responsive-angular-ecommerce-template/22905358?s_rank=3"
                        target="_blank" class="btn btn-block purchase_btn"><img src="../assets/images/icon/angular.png"
                            alt="" class="img-fluid"> Hijabku Angular</a>
                    <a href="https://themeforest.net/item/multikart-responsive-react-ecommerce-template/23067773?s_rank=2"
                        target="_blank" class="btn btn-block purchase_btn"><img src="../assets/images/icon/react.png"
                            alt="" class="img-fluid"> Hijabku React</a>
                    <a href="https://themeforest.net/item/multikart-multipurpose-shopify-sections-theme/23093831?s_rank=1"
                        target="_blank" class="btn btn-block purchase_btn"><img src="../assets/images/icon/shopify.png"
                            alt="" class="img-fluid"> Hijabku Shopify</a>
                </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Apr 2020 10:58:47 GMT -->
</html>