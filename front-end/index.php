    ...
    <div class="slide-1 home-slider">
        <div>
            <div class="home  text-center">
                <img src="../assets/images/slider/hijab-1.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    ...
                                    <h1>men fashion</h1>
                                    <a href="category.php" class="btn btn-solid">shop now</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="pb-0 ratio2_1">
    ...
    <div class="container">
        <div class="row partition2">
            <div class="col-md-6">
                <a href="category.php">
                    <div class="collection-banner mb-2 p-right text-center">
                        <div class="img-part">
                            <img src="../assets/images/product/category-1.jpg" style="background-size: cover;"
                ...
                <div class="product-4 product-m no-arrow">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product.php"><img src="../assets/images/product/p1.jpg"
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="product.php">
                                    <img src="../assets/images/product/p1.jpg" class="img-fluid blur-up lazyload bg-img"
                                        alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product.php"><img src="../assets/images/product/p1.jpg"
                            ...
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                        class="fa fa-shopping-cart"></i></button> <a href="javascript:void(0)"
                                    title="Add to Wishlist"><i class="fa fa-heart" aria-hidden="true"></i></a> <a
                                    href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i
                                        class="fa fa-search" aria-hidden="true"></i></a> <a href="compare.html"
                                    title="Compare"><i class="fa fa-reload" aria-hidden="true"></i></a></div>
                        </div>
                        <div class="product-detail">
                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i>
                                    ...
                                    <div class="img-wrapper">
                                        ...
                                        <div class="cart-info cart-wrap">
                                            <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                                ...
                                                href="javascript:void(0)" title="Add to Wishlist"><i class="fa fa-heart"
                                                    aria-hidden="true"></i></a> <a href="#" data-toggle="modal"
                                                data-target="#quick-view" title="Quick View"><i class="fa fa-search"
                                                    aria-hidden="true"></i></a> <a href="compare.html"
                                                title="Compare"><i class="fa fa-reload" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                    <div class="product-detail">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
