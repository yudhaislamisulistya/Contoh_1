                    ...
                    <div class="col-sm-3 collection-filter">
                        ...
                        <div class="theme-card">
                            ...
                            <div class="offer-slider slide-1">
                                <div>
                                    <div class="media">
                                        <a href="product.php"><img class="img-fluid blur-up lazyload"
                                                src="../assets/images/product/p1.jpg" alt=""></a>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="top-banner-wrapper">
                                        <a href="product.php"><img src="../assets/images/mega-menu/2.jpg"
                                                    ...
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            ...
                                                            <div class="cart-info cart-wrap">
                                                                <button data-toggle="modal" data-target="product.phpaddtocart"
                                                                    title="Add to cart"><i
                                                                    ...
                                                                    href="product.php" data-toggle="modal"
                                                                    data-target="product.phpquick-view" title="Quick View"><i
                                                                        class="fa fa-search" aria-hidden="true"></i></a> <a
                                                                    href="compare.html" title="Compare"><i
                                                                        class="fa fa-reload" aria-hidden="true"></i></a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6 col-md-6 col-sm-12">
                                                        <nav aria-label="Page navigation">
                                                            <ul class="pagination">
                                                                <li class="page-item"><a class="page-link" href="product.php"
                                                                ...
                                                                <li class="page-item active"><a class="page-link"
                                                                        href="product.php">1</a></li>
                                                                <li class="page-item"><a class="page-link"
                                                                        href="product.php">2</a></li>
                                                                <li class="page-item"><a class="page-link"
                                                                        href="product.php">3</a></li>
                                                                <li class="page-item"><a class="page-link" href="product.php"
